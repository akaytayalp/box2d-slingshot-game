...
{	
	...
	import com.ghostmonk.ui.interactive.buttons.SimpleMCToggleBtn;
	...
	public class SlingShotGame extends Sprite
	{
		...
		private var volumeBtn:SimpleMCToggleBtn;
		
		public function SlingShotGame()
		{
			volumeBtn = new SimpleMCToggleBtn( new VolumeBtn(), OnVolumeToggle );
			addEventListener( Event.ADDED_TO_STAGE, OnAddedToStage );
			SoundUtility.PlayLoop();
		}
		...
		private function OnAddedToStage( e:Event ) : void
		{
			...
			volumeBtn.view.x = stage.stageWidth - volumeBtn.view.width;
			volumeBtn.view.y = stage.stageHeight - volumeBtn.view.height;
			stage.addChild( volumeBtn.view );
		}
		...
		private function OnVolumeToggle( isOn:Boolean ) : void
		{
			if( isOn )
				SoundUtility.StopLoop();
			else
				SoundUtility.PlayLoop();
		}
	}
