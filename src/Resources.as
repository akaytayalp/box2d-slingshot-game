package 
{
	...
	public class Resources 
	{
		...
		public static var ButtonNext:String;
		
		public static function SetLanguage( isEnglish:Boolean ) : void
		{
			SoundUtility.IsEnglish = isEnglish;
			...
			ButtonNext = isEnglish ? "Next" : "Suivant"; 
			Disclaimer = isEnglish ? "© 2011 Authorized by The Federal Liberal Agency of Canada, registered agent for the Liberal Party of Canada." : "© 2011 Autorisé par l'Agence fédérale libérale du Canada, agent enregistré du Parti libéral du Canada";
			...
			Instruction2 = isEnglish ? "2. Aim and unleash him towards the Canadian groups and institutions on Harper’s hit list" : "2. Lancez-le en direction des différents groupes et institutions du Canada sur la liste de Harper";
			...
			Veterans = isEnglish ? "Veterans" : "Anciens combattants";
